...
private:
	...
	double EvaluateFuncLimit(const MPCOS<1>& InFunction);
	double EvaluateFuncLimit(const MPSIN<1>& InFunction);
	double EvaluateFuncLimit(const MPTAN<1>& InFunction);
...
//
template<typename Function>
inline double Limit<Function>::EvaluateFuncLimit(const MPSIN<1>& InFunction)
{
	std::vector<std::pair<double, double>> PosDirVec;
	std::vector<std::pair<double, double>> NegDirVec;
...
template<typename Function>
inline double Limit<Function>::EvaluateFuncLimit(const MPCOS<1>& InFunction)
{
	std::vector<std::pair<double, double>> PosDirVec;
	std::vector<std::pair<double, double>> NegDirVec;
...
template<typename Function>
inline double Limit<Function>::EvaluateFuncLimit(const MPTAN<1>& InFunction)
{
	std::vector<std::pair<double, double>> PosDirVec;
	std::vector<std::pair<double, double>> NegDirVec;
