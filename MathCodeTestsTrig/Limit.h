...
private:
	...
	double EvaluateFuncLimit(const RationalFunction<QuadraticFunction, LinearFunction>& InFunction);
	double EvaluateFuncLimit(const RationalFunction<ConstantFunction, QuadraticFunction>& InFunction);
	double EvaluateFuncLimit(const QuadraticFunction& InFunction);
	double EvaluateFuncLimit(const LinearFunction& InFunction);
	double EvaluateFuncLimit(const CubicFunction& InFunction);

	// TODO IMPORTANT: How do I handle the differences in power variables here?
	double EvaluateFuncLimit(const TrigometricFunction<MPCOS, 1>& InFunction);

	//double EvaluateFuncLimit(const TrigometricFunction<MPSIN, 1>& InFunction);
	//double EvaluateFuncLimit(const TrigometricFunction<MPTAN, 1>& InFunction);
...
template<typename Function>
inline double Limit<Function>::EvaluateFuncLimit(const RationalFunction<LinearFunction, LinearFunction>& InFunction)
{
...
template<typename Function>
inline double Limit<Function>::EvaluateFuncLimit(const RationalFunction<QuadraticFunction, LinearFunction>& InFunction)
{
...
template<typename Function>
inline double Limit<Function>::EvaluateFuncLimit(const RationalFunction<ConstantFunction, QuadraticFunction>& InFunction)
{
	std::vector<std::pair<double, double>> PosDirVec;
	std::vector<std::pair<double, double>> NegDirVec;
...
template<typename Function>
inline double Limit<Function>::EvaluateFuncLimit(const QuadraticFunction & InFunction)
{
	std::vector<std::pair<double, double>> PosDirVec;
	std::vector<std::pair<double, double>> NegDirVec;
...
template<typename Function>
inline double Limit<Function>::EvaluateFuncLimit(const LinearFunction & InFunction)
{
	std::vector<std::pair<double, double>> PosDirVec;
	std::vector<std::pair<double, double>> NegDirVec;
...
template<typename Function>
inline double Limit<Function>::EvaluateFuncLimit(const CubicFunction & InFunction)
{
	std::vector<std::pair<double, double>> PosDirVec;
	std::vector<std::pair<double, double>> NegDirVec;
...
//
//template<typename Function>
//inline double Limit<Function>::EvaluateFuncLimit(const TrigometricFunction<MPSIN, 1>& InFunction)
//{
//	std::vector<std::pair<double, double>> PosDirVec;
//	std::vector<std::pair<double, double>> NegDirVec;
//
...
template<typename Function>
inline double Limit<Function>::EvaluateFuncLimit(const TrigometricFunction<MPCOS, 1>& InFunction)
{
	std::vector<std::pair<double, double>> PosDirVec;
	std::vector<std::pair<double, double>> NegDirVec;
...
//template<typename Function>
//inline double Limit<Function>::EvaluateFuncLimit(const TrigometricFunction<MPTAN, 1>& InFunction)
//{
//	std::vector<std::pair<double, double>> PosDirVec;
//	std::vector<std::pair<double, double>> NegDirVec;
//
